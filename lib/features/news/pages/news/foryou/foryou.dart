...
import '../../../../../state/bloc/news/news_bloc.dart';
import '../../../../../state/bloc/news/news_event.dart';
import '../../../../../state/bloc/news/news_state.dart';
...
class _ForYouScreenState extends State<ForYouScreen>
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      if (bloc.state.forYouNews.isEmpty) {
  ...
  void _scrollListener() {
    if (_scrollController.position.pixels >=
      ...
      if (!newsState.isForYouNextPageLoading &&
          !newsState.isForYouLastPage) {
        context.read<NewsBloc>().add(
        ...
        child: RefreshIndicator(
          ...
          child: BlocBuilder<NewsBloc, NewsState>(
            builder: (context, state) {
              final allNews = state.forYouNews.isNotEmpty
                  ? state.forYouNews
                  : [
                      ...state.forYouTeamNews.values.expand((list) => list),
                      ...state.forYouPlayerNews.values.expand((list) => list),
                    ]..sort((a, b) {
                      final dateA = a.publishedDate != null
                          ? DateTime.tryParse(a.publishedDate!)
                          : null;
                      final dateB = b.publishedDate != null
                          ? DateTime.tryParse(b.publishedDate!)
                          : null;
              ...
              return ListView.builder(
                ...
                itemCount:
                    allNews.length + (state.isForYouNextPageLoading ? 1 : 0),
    ...
    builder: (context) => NewsDetailPage(id: news.id),
        ...
        child: Stack(
          children: [
            // Hero Image
            networkImageWithSvg(
              url: news.mainImages.isNotEmpty ? news.mainImages.first.url : '',
              height: 280.h,
