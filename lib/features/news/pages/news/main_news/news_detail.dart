...
import 'package:blogapp/functions/download_and_save_image.dart';
...
class _NewsDetailPageState extends State<NewsDetailPage>
  ...
  void initState() {
    ...
    // IMPORTANT: Force initial rebuild so caption of first image (index 0) shows immediately
    WidgetsBinding.instance.addPostFrameCallback((_) {
      if (mounted) {
        setState(() {
          // This ensures _currentPage = 0 is processed and UI updates
        });
      }
    });
  }
  ...
  Widget build(BuildContext context) {
        ...
        body: Center(
          child: Column(
            ...
            children: [
              ...
              Text(
                _hasError ? DemoLocalizations.networkProblem : '',
              ...
              ElevatedButton(
                ...
                child: Row(
                  ...
                  children: [
                    Icon(Icons.refresh, size: 16.sp, color: Colors.black),
                    SizedBox(width: 8.w),
                    Text(
    ...
    // Get caption for the CURRENT image (with fallback)
    final currentImage = imageCount > 0 ? _news!.mainImages[_currentPage] : null;
    final String currentCaption = (currentImage?.caption ?? '').trim();
    final String fallbackCaption = (_news?.figCaption ?? '').trim();
    final String displayCaption = currentCaption.isNotEmpty
        ? currentCaption
        : fallbackCaption;
