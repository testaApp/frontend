...
class FollowingBloc extends Bloc<FollowingEvent, FollowingState> {
  ...
  Future<void> _handleAddFavouriteTeamEvent(
    ...
    try {
      ...
      _syncTeamToBackend(event.teamId!, 'add', teamName: event.teamName);
    } catch (e) {
  ...
  Future<void> _handleRemoveFavouriteTeamEvent(
    ...
    try {
      ...
      _syncTeamToBackend(event.teamId!, 'remove', teamName: event.teamName);
    } catch (e) {
  ...
  Future<void> _syncTeamToBackend(
    int teamId,
    String action, {
    String? teamName,
  }) async {
    try {
      ...
      final payload = <String, dynamic>{'teamId': teamId.toString()};
  ...
  Future<void> _handleAddFavouritePlayerEvent(
    ...
    try {
      ...
      _syncPlayerToBackend(event.playerId!, 'add', playerName: event.playerName);
    } catch (e) {
  ...
  Future<void> _syncPlayerToBackend(
    int playerId,
    String action, {
    String? playerName,
  }) async {
    try {
      ...
      final payload = <String, dynamic>{'playerId': playerId.toString()};
  ...
  Future<void> _handleSyncPendingOperations(
    ...
    final teamNames = _storageService.getFollowedTeamNames();
    final playerNames = _storageService.getFollowedPlayerNames();
